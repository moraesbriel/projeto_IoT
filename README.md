...
O código principal está localizado na pasta `code.ino` e foi desenvolvido na Arduino IDE. O arquivo `Artigo Científico.pdf` inclui o documento especificando detalhadamente os módulos de conexão Wi-Fi, configuração do MQTT e funções de coleta de dados e controle do relé.
